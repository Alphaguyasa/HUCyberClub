        ...
        <section className={`w-full py-20 px-6 ${spectral.className}`} style={{ backgroundColor: '#FFFEF0' }}>
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16">
              <h2 className="font-light mb-3" style={{ fontSize: '36px', color: '#1D2023' }}>
                Register for Events
              </h2>
              <p className="font-light" style={{ fontSize: '18px', color: '#C9C73C' }}>
                Secure your spot at our upcoming workshops and competitions
              </p>
            </div>

            {/* Three columns: Form | Map | Contact Info */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
              ...
              {/* Contact Info */}
              <div className="flex flex-col gap-8" style={{ color: '#1D2023' }}>
                <div>
