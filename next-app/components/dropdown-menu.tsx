  ...
  return (
    <div className="relative">
      <Button
        ...
        className="rounded-xl border-none bg-[#11111198] px-4 py-2 shadow-[0_0_20px_rgba(0,0,0,0.2)] backdrop-blur-sm hover:bg-[#111111d1]"
      >
        {children ?? "Menu"}
        <>
          <motion.span
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute z-10 mt-2 flex w-48 flex-col gap-2 rounded-xl bg-[#11111198] p-1 shadow-[0_0_20px_rgba(0,0,0,0.2)] backdrop-blur-sm"
          >
