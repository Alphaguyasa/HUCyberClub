  ...
  return (
    <footer className={`w-full py-10 ${spectral.className}`} style={{ backgroundColor: '#FFFEF0' }}>
      <div className="relative bg-white rounded-3xl max-w-2xl mx-auto px-8 py-10 flex flex-col items-center gap-6">
        ...
        {/* Copyright */}
        <p className="text-center" style={{ fontSize: '15px', color: '#1D2023' }}>
          © {currentYear} Haramaya University Cyber Security Club. All rights reserved.
        </p>

        {/* Social Links */}
        <div className="flex gap-6 items-center">
          <Link href="https://linkedin.com" target="_blank" rel="nofollow noopener" aria-label="LinkedIn"
            className="transition-opacity hover:opacity-60">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" style={{ color: '#1D2023' }}>
              <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
            </svg>
          </Link>
          <Link href="https://github.com" target="_blank" rel="nofollow noopener" aria-label="GitHub"
            className="transition-opacity hover:opacity-60">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" style={{ color: '#1D2023' }}>
          ...
          <Link href="https://twitter.com" target="_blank" rel="nofollow noopener" aria-label="Twitter"
            className="transition-opacity hover:opacity-60">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" style={{ color: '#1D2023' }}>
