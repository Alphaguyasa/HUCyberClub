    ...
    <div className={`relative ${spectral.className}`}>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 text-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <h1 className="mb-6 whitespace-nowrap" style={{ fontSize: '42px', color: '#ffffff', fontWeight: 400 }}>
            Welcome to the Haramaya University Cyber Security Club
          </h1>
          <p className="whitespace-nowrap" style={{ fontSize: '18px', color: '#f0f0f0', fontWeight: 300 }}>
