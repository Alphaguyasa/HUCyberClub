...
import SkillWorkshops from "./skill-workshops";
import CTFSection from "./ctf-section";
  ...
  return (
    <div className={`relative ${spectral.className}`}>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 text-center">
        <img src="/images/event.jpg" alt="Events" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="mb-10" style={{ fontSize: '18px', color: '#f0f0f0', fontWeight: 300 }}>
            Enhance your skills and join our community activities
          </p>
          <div className="flex gap-4 justify-center">
            ...
            <Link href="/about">
              <button className="px-10 py-4 font-medium transition-opacity hover:opacity-90" style={{ backgroundColor: 'transparent', border: '2px solid #ffffff', color: '#ffffff', borderRadius: '9999px', fontSize: '18px' }}>
                Learn More
              </button>
            </Link>
          </div>
